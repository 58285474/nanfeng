...
class Spider(Spider):
    ...
    # 📂 【配置区】
    # ==========================================================================
    PY_DIR    = "/storage/emulated/0/影视仓本地线路/智能接口/py"
    JS_DIR    = "/storage/emulated/0/影视仓本地线路/智能接口/js"
    JAR_DIR   = "/storage/emulated/0/影视仓本地线路/智能接口/jar"
    SAVE_PATH = "/storage/emulated/0/影视仓本地线路/智能接口/智能刷新接口.json"
