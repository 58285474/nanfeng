...
async function sendNotify(text, desp, params = {}, author = '\n\n本通知 By ccwav Mod', strsummary = "") {
    ...
    await Promise.all([
        ...
        btgBotNotify(text, desp), //telegram 过滤
    ...
    return new Promise((resolve) => {
        const options = {
            ...
            headers: {
                ...
                "User-Agent": "jdapp;iPhone;12.6.0;15.0;network/wifi;Mozilla/5.0 (iPhone; CPU iPhone OS 15_0 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148;supportJDSHWK/1",
            },
        }
    ...
    return new Promise(async (resolve) => {
        ...
        for (const userId of B_TG_USER_IDS) {
            ...
            try {
                ...
                if (data.err) {
                    console.log('telegram发送通知消息失败，请检查机器人是否所属填写ID频道成员！！\n');
                ...
                await sleep(2000); // Pause for 2 second between each iteration
            }
        }
